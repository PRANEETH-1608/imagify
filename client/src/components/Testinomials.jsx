...
const Testinomials = () => {
  return (
     ...
     className='flex flex-col items-center justify-center my-20 py-12  '>
      ...
      <p className='text-gray-500 mb-8 '>What our user Saying??</p>

        <div className='flex flex-wrap gap-6'>

            {testimonialsData.map((testimonail,index)=>(

                <div key={index} className='bg-white/20 rounded-lg p-12 shadow-md border w-80 m-auto cursor-pointer hover:scale-[1.02] transition-all '>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <p className='flex mb-4'>{testimonail.role}</p>
